...
class SconUnserializableError extends SconSerializeError {
	constructor(msg = "Cannot serialize unknown object type"){
		super(msg);
	}
}
...
class SconInvalidKeyError extends SconSerializeError {
	constructor(msg = "Property name is invalid"){
		super(msg);
	}
}
SconInvalidKeyError.prototype.name = "SconInvalidKeyError";
/**
 * @extends SconUnserializableError
 * Throws if you try to encode a circular object that isn't referenced
 */
class SconCircularError extends SconUnserializableError {
	constructor(msg = "Cannot encode circular value without using referenced objects"){
		super(msg);
	}
}
SconCircularError.prototype.name = "SconCircularError";
