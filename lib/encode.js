...
class SconEncoder {
	...
	encode(value){
		...
		if(
			...
			throw new SconUnserializableError("Cannot use referenced objects and referenced strings without explicit reference definition being enabled");
		}
		if(value === undefined){
...
module.exports = {SconEncoder, encode};
